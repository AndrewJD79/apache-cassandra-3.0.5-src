...
def main(argv):
	...
	Cons.P("Exp id: %s" % _exp_id)

	RunPssh("/home/ubuntu/work/acorn-tools/cass/cass-stop.py")
	RunPssh("rm -rf /home/ubuntu/work/acorn/data")
	RunPssh("/home/ubuntu/work/acorn-tools/cass/cass-restart.py")
